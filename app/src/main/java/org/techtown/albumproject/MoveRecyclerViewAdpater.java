...
public class MoveRecyclerViewAdpater extends RecyclerView.Adapter<MoveRecyclerViewAdpater.ViewHolder> {

    private List<Linux_File_Item> file_list;
    private int itemLayout;
    private Context context;

    public MoveRecyclerViewAdpater(List<Linux_File_Item> file_list, int itemLayout, Context context) {
    ...
    @Override
    public MoveRecyclerViewAdpater.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(itemLayout,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(MoveRecyclerViewAdpater.ViewHolder holder, int position) {
